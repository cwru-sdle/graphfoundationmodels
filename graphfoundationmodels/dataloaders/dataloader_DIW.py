...
class DIWDataset(ImputationDataset):
    def __init__(self,
        ...
        target, connectivity = self._load_from_parquet(target_path, connectivity_path)
    ...
    def _load_from_parquet(self, target_path):
        ...
        return node_ftr, adj_matrix



#%%
DATA_PATH = '/mnt/vstor/CSE_MSE_RXF131/staging/mds3/llnl/DIW/2304giera-hdf5_cwru/diw-stgnn-featmat.parquet'

diws = DIWDataset(DATA_PATH, eval_mask=torch.zeros((1747, 615, 12), dtype=torch.bool),
                                  window=250,
                                  stride=25
)
